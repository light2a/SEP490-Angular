...
| Proctoring UI (webcam, tab-switch/paste flags — dùng `faceEnrollRequired`/`sessionId` của `CampaignInterview` + `CampaignApi.reportFlag/faceEnroll/faceCheck`) | todo (agent khác) |
